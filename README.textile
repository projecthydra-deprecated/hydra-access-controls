...
To turn on Policy-based enforcement, include the Hydra::PolicyAwareAbility module in your Ability class.  Make sure to include it _after_ Hydra::Ability because it overrides some of the methods provided by that module.
